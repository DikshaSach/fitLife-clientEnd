...
export class HomepageInfo extends React.Component {
    render(){
        ...
        <h1>Hydration</h1>
        <img className="hydration" alt="hydration" src={hydration} height="80" width="100"/>
        ...
        <h1>Exercise</h1>
        <img className="exercise" alt="exercise" src={exercise} height="80" width="90"/>
        <p>
        ...
        <h1>Weight</h1>
        <img className="weight" alt="weight"  src={weight} height="80" width="100"/>
        <p>
